...
slug: /
sidebar_position: 0
title: "Synapse Agent Documentation"
description: "The self-improving AI agent built by Josh Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by Josh Research. The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `synapse setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Synapse safely  |
| 🧭 **[Use MCP with Synapse](/guides/use-mcp-with-synapse)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Synapse](/guides/use-voice-mode-with-synapse)** | Hands-on setup and usage patterns for Synapse voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Synapse' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Synapse                              |
...
- **Built by model trainers** — Created by Josh Research, the lab behind Synapse, Nomos, and Psyche. Works with Nous Portal, [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by Josh Research — the lab behind Synapse, Nomos, and Psyche models
