...
description: "How the Synapse Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Synapse Desktop app connects to a **gated gateway** (a hosted or
...
For Synapse specifically, native sign-in means:
...
- [Run Synapse with Nous Portal](./run-synapse-with-nous-portal.md)
