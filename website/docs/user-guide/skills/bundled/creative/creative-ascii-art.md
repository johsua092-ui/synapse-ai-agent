...
```bash
python3 -m pyfiglet "SYNAPSE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=SYNAPSE&font=Slant" | boxes -d stone
```
