...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/web-development/page-agent` |
...
- User wants **Synapse itself to drive a browser** → use Synapse' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
