...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Synapse Agent |
| License | MIT |
...
The script reads `${SYNAPSE_HOME:-~/.synapse}/.env` for two optional defaults:
...
Helper script: `~/.synapse/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.synapse/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${SYNAPSE_HOME:-~/.synapse}/.env`.
...
```bash
python3 ~/.synapse/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.synapse/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
