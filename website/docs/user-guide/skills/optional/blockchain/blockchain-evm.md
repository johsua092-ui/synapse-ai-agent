...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Synapse Agent |
| License | MIT |
...
Helper script path: `~/.synapse/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.synapse/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.synapse/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.synapse/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
