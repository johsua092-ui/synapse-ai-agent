...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing synapse tool access (web_search, file ops). Stateless. |
