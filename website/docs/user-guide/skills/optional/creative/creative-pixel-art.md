...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.synapse/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.synapse/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Synapse installs package this)
