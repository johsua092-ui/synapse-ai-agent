...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`synapse-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-synapse-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Synapse Agent via the native MCP client. This is the preferred
...
Then configure Synapse Agent to connect via HTTP:
