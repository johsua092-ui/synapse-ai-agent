...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/research/gitnexus-explorer` |
...
| Related skills | [`synapse-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-synapse-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/github/github-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  synapse-agent users don't need.
