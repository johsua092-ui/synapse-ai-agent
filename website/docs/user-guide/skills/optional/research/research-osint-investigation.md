...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Synapse Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $SYNAPSE_OSINT_CACHE/icij/ (default: ~/.cache/synapse-osint/icij/).
...
# Set SYNAPSE_OSINT_UA=your-app/1.0 (your@email) to identify yourself
