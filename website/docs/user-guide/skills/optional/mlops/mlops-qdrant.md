...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/mlops/qdrant` |
...
- **[Advanced Usage](https://github.com/johsua092-ui/synapse-ai-agent/blob/main/optional-skills/mlops/qdrant/references/advanced-usage.md)** - Distributed mode, hybrid search, recommendations
- **[Troubleshooting](https://github.com/johsua092-ui/synapse-ai-agent/blob/main/optional-skills/mlops/qdrant/references/troubleshooting.md)** - Common issues, debugging, performance tuning
