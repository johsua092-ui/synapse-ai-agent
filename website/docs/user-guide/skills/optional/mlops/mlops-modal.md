...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/mlops/modal` |
...
- **[Advanced Usage](https://github.com/johsua092-ui/synapse-ai-agent/blob/main/optional-skills/mlops/modal/references/advanced-usage.md)** - Multi-GPU, distributed training, cost optimization
- **[Troubleshooting](https://github.com/johsua092-ui/synapse-ai-agent/blob/main/optional-skills/mlops/modal/references/troubleshooting.md)** - Common issues and solutions
