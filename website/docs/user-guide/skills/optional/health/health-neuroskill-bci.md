...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/health/neuroskill-bci` |
...
Connect Synapse to a running [NeuroSkill](https://neuroskill.com/) instance to read
