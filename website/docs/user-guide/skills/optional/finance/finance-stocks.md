...
| | |
|---|---|
| Source | Optional — install with `synapse skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Synapse Agent |
| License | MIT |
...
```
SCRIPT=~/.synapse/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.synapse/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
