...
Message-template support (the workaround for outside-window sends) is not yet implemented in Synapse. If you need it, please [open an issue](https://github.com/johsua092-ui/synapse-agent/issues) — it's planned but waiting on a clear demand signal.
