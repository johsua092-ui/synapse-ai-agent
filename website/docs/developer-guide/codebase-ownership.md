...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `synapse_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `synapse_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Synapse Plugin](plugins/index.md) |
...
| Session storage | `synapse_state.py` | [Session Storage](session-storage.md) |
