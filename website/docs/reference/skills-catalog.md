...
| [`synapse-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-synapse-agent) | Use, configure, theme, extend, and orchestrate Synapse Agent. | `autonomous-ai-agents/synapse-agent` |
...
| [`synapse-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-synapse-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development/synapse-agent-skill-authoring` |
| [`inspecting-synapse-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-synapse-desktop-dom) | Read the live Synapse desktop DOM/CSS over CDP. | `software-development/inspecting-synapse-desktop-dom` |
...
| [`plan`](/docs/user-guide/skills/bundled/software-development/software-development-plan) | Write a markdown plan to .synapse/plans/; no execution. | `software-development/plan` |
