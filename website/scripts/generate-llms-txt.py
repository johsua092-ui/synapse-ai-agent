...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "Install: `curl -fsSL https://raw.githubusercontent.com/Josh Research/"
        "synapse-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/johsua092-ui/synapse-ai-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https:///docs\n",
        "Short index: https:///docs/llms.txt\n",
        "\n---\n\n",
    ]
