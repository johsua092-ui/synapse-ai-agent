...
def _profile_user_agent() -> str:
    """Return a ``synapse-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from synapse_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"synapse-cli/{_ver}"
    except Exception:
        return "synapse-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # synapse-cli UA so the catalog endpoint is reachable.
