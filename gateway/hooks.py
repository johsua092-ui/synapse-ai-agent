...
Hooks are discovered from ~/.synapse/hooks/ directories, each containing:
...
HOOKS_DIR = get_synapse_home() / "hooks"
    ...
    def discover_and_load(self) -> None:
        ...
        for hook_dir in sorted(HOOKS_DIR.iterdir()):
            ...
            try:
                ...
                module_name = f"synapse_hook_{hook_name}"
