...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$SYNAPSE_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_synapse_dir("platforms/whatsapp/session", "whatsapp/session")
