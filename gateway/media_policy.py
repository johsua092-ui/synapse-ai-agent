...
from environment variables:
  ...
  - ``SYNAPSE_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``SYNAPSE_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``SYNAPSE_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``synapse cron run`` in the CLI, ``synapse send``, a
...
_STRICT_ENV = "SYNAPSE_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "SYNAPSE_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "SYNAPSE_MEDIA_TRUST_RECENT_FILES"
