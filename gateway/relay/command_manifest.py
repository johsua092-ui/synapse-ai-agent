...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Synapse session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Synapse session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Synapse agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Synapse Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Synapse gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Synapse session in it",
