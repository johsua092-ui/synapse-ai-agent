#!/usr/bin/env python3
"""
SWE Runner with Synapse Trajectory Format

A runner that uses Synapse-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Synapse-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Synapse-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Synapse format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Synapse-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Synapse-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Synapse Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Synapse-Agent's built-in execution environments
    and outputs trajectories in Synapse-Agent format.
    """
    ...
    def _convert_to_synapse_format(
        self,
        ...
        """
        Convert internal message format to Synapse trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Synapse trajectory format
        trajectory = self._convert_to_synapse_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Synapse trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Synapse Trajectory Format")
    print("=" * 60)
