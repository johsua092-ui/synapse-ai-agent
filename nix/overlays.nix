# nix/overlays.nix — Expose pkgs.synapse-agent for external NixOS configs
#
...
# `pkgs.synapse-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    synapse-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
