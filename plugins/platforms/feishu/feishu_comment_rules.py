...
Config: ~/.synapse/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.synapse/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_synapse_home()`` helper (SYNAPSE_HOME-aware and
...
RULES_FILE = get_synapse_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_synapse_home() / "feishu_comment_pairing.json"
