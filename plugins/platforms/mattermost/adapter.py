...
required — uses aiohttp which is already a Synapse dependency.
...
def interactive_setup() -> None:
    ...
    ``synapse_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Synapse delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # synapse_cli/setup.py::_setup_mattermost function.
