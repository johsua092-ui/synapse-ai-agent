...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Synapse gateway adapter.

    Each inbound phone number gets its own Synapse session (multi-tenant).
...
# static dict in synapse_cli/gateway.py, and the _send_sms dispatch in
