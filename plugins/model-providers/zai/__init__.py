...
request omits ``thinking``.  Synapse' ``reasoning_config = {"enabled": False}``
...
:meth:`ZaiProfile.build_api_kwargs_extras` translates the Synapse reasoning
...
(per Z.AI / BigModel docs).  Synapse' richer effort scale is collapsed onto
...
def _glm_5_2_reasoning_effort(
    ...
    """Map Synapse reasoning effort onto GLM's native vocabulary.
