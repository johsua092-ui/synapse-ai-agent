...
# When the user hasn't picked a reasoning effort, Synapse passes
...
# ON at this effort — matching the "medium (default)" that Synapse' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Synapse' effort vocabulary onto Solar's accepted set via the
