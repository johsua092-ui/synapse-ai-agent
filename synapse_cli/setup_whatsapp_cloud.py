...
Entry point: ``synapse whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``synapse_cli/main.py``).
...
Synapse gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures Synapse to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  Synapse needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the Synapse gateway in another terminal:")
    print("         synapse gateway")
    print()
    ...
    print()
    print("  Docs: https:///docs/user-guide/")
