"""
Skills configuration for Synapse Agent.
`synapse skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.synapse/config.yaml under:
...
from synapse_cli.config import cfg_get, load_config, save_config
from synapse_cli.colors import Colors, color
from synapse_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `synapse skills`."""
    from synapse_cli.curses_ui import curses_checklist
