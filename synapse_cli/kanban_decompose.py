...
Invoked by ``synapse kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Synapse Agent board.
...
def _profile_author() -> str:
    """Mirror of ``synapse_cli.kanban._profile_author``."""
    return (
