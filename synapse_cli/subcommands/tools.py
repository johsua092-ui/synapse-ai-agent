"""``synapse tools`` subcommand parser.
...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run 'synapse tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # synapse tools list [--platform cli]
    ...
    # synapse tools disable <name...> [--platform cli]
    ...
    # synapse tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `synapse tools` runs after you pick a provider that\n"
