"""Relay subscriber for the persisted Synapse shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Synapse counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Synapse shared metric: %s",
                    metric_name,
                    exc_info=True,
                )
