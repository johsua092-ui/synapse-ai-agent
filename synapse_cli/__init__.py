"""
Synapse CLI - Unified command-line interface for Synapse Agent.

Provides subcommands for:
- synapse chat          - Interactive chat (same as ./synapse)
- synapse gateway       - Run gateway in foreground
- synapse gateway start - Start gateway service
...
def _ensure_utf8():
    ...
    can even start — e.g. `synapse setup` on a fresh Pi.
    ...
    synapse_cli/stdio.py::configure_windows_stdio() runs later from the entry
