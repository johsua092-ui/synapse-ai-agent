...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of johsua092-ui/synapse-ai-agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of johsua092-ui/synapse-ai-agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (johsua092-ui/synapse-ai-agent#67052). ``ok`` stays
