...
Trust levels:
  - builtin:   Ships with Synapse. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.synapse/\.env|\~/\.synapse/\.env',
     "synapse_env_access", "critical", "exfiltration",
     "directly references Synapse secrets file"),
    ...
    (r'\.synapse/config\.yaml|\.synapse/SOUL\.md',
     "synapse_config_mod", "critical", "persistence",
     "references Synapse configuration files directly"),
...
# scan. `.skillignore` is the Synapse-native name; `.clawhubignore` is honored
