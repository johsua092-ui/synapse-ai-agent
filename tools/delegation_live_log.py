...
def live_transcript_root() -> Path:
    """Root directory for live transcripts (profile-safe, never ~/.synapse)."""
    from synapse_constants import get_synapse_dir

    return get_synapse_dir("cache/delegation", "delegation_cache") / "live"
...
class LiveTranscriptWriter:
    ...
    def __init__(self, delegation_id: str, task_index: int, goal: str,
        ...
        try:
            ...
            header = [
                "=== Synapse subagent live transcript ===",
