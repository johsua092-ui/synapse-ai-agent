...
The A/B battery behind PR [#81958](https://github.com/johsua092-ui/synapse-ai-agent/pull/81958)
...
- **Arms differ only by tree + config.** `base` runs the built-in twelve
  ...
  digest's value). Each cell gets a throwaway `SYNAPSE_HOME`; web-fetch
