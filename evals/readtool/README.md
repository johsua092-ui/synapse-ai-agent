...
benchmarked ten harnesses on hostile-file handling — and whose Synapse column
...
Every task runs the full Synapse agent (file + terminal + search toolsets)
...
Rules of engagement (from synapsebench discipline):
