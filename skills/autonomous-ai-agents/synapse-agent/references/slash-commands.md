...
Registry of record: `synapse_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Synapse config+state snapshots (CLI)
...
/update                  Update Synapse to latest
