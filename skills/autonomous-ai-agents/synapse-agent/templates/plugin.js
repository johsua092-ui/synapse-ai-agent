/**
 * Synapse desktop plugin template. Save as:
 *   <synapse home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <synapse home> is ~/.synapse by default, or ~/.synapse/profiles/<name>
 * when running a named profile (`synapse -p <name>`). Run `synapse doctor` (or
 ...
 * Only these imports resolve: @synapse/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@synapse/plugin-sdk'
