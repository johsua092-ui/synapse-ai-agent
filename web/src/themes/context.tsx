...
const FONT_STORAGE_KEY = "synapse-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `synapse_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "synapse-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-synapse-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-synapse-theme-font", "true");
