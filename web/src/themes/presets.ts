 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `synapse_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Synapse Teal",
  description: "Classic dark teal — the canonical Synapse look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Synapse Teal (Large)",
  description: "Synapse Teal with bigger fonts and roomier spacing",
