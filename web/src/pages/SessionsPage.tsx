...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    synapse_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__synapse_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id), {
          ...
          headers: {
            "X-Synapse-Session-Token":
              (window as unknown as { __SYNAPSE_SESSION_TOKEN__?: string })
                .__SYNAPSE_SESSION_TOKEN__ ?? "",
          },
        });
