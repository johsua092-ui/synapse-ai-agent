 ...
 * `window.__SYNAPSE_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Synapse brand in the top bar
 ...
 *  `window.__SYNAPSE_PLUGINS__.registerSlot(...)`.
 *
