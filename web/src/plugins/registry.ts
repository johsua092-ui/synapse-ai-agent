 ...
 *
 * Plugins call window.__SYNAPSE_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__SYNAPSE_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__SYNAPSE_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__SYNAPSE_PLUGIN_SDK__ = {
    ...
    // window.__SYNAPSE_SESSION_TOKEN__ directly.
    authedFetch,
