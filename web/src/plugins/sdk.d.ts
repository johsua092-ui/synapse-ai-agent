/**
 * Synapse Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__SYNAPSE_PLUGIN_SDK__`` and
 * ``window.__SYNAPSE_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__SYNAPSE_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``SynapsePluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@synapse/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__SYNAPSE_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__SYNAPSE_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__SYNAPSE_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface SynapsePluginSDK {
...
declare global {
  interface Window {
    __SYNAPSE_PLUGIN_SDK__?: SynapsePluginSDK;
    __SYNAPSE_PLUGINS__?: PluginRegistry;
  }
}
