...
export interface Translations {
  ...
  status: {
    ...
    updateSynapseConfirmMessage?: string;
    updateSynapseConfirmNow?: string;
    updateSynapseConfirmTitle?: string;
    updatingSynapse: string;
  ...
  // ── Achievements plugin (plugins/synapse-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
