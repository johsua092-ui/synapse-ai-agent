...
Data file: $SYNAPSE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_SYNAPSE_HOME = Path(os.environ.get("SYNAPSE_HOME", Path.home() / ".synapse"))
DATA_DIR = _SYNAPSE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
