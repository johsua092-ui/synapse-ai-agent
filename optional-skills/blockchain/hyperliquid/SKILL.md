...
```bash
python ~/.synapse/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.synapse/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.synapse/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
