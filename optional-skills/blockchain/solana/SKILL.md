...
python ~/.synapse/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.synapse/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.synapse/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.synapse/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.synapse/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.synapse/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
