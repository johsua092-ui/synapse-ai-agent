...
All per-subject data lives under PDD_DATA_DIR (default: $SYNAPSE_HOME/unbroker),
which is the same trust boundary Synapse uses for .env and OAuth tokens.
"""
...
def data_dir() -> Path:
    ...
    return Path(override) if override else synapse_home() / "unbroker"
