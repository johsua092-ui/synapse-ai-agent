...
def _state_dir() -> Path:
    ...
    # Default: $SYNAPSE_HOME/watcher-state/, falling back to ~/.synapse/watcher-state/.
    synapse_home = os.environ.get("SYNAPSE_HOME") or str(Path.home() / ".synapse")
    return Path(synapse_home) / "watcher-state"
