...
const POPOUT_STORAGE_KEY = 'synapse.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'synapse.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'synapse.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'synapse.desktop.composerPopout.position'
