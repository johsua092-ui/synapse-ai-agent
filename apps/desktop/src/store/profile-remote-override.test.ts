...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://synapse.example.com:8443/x')).toBe('synapse.example.com:8443')
    expect(remoteHostLabel('https://synapse.example.com:443')).toBe('synapse.example.com')
    expect(remoteHostLabel('http://synapse.example.com:80')).toBe('synapse.example.com')
  })
