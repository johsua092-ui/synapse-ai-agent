...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('synapse.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('synapse.desktop.unreadFinishedSessions')
