...
function identityForConnection(connection: SynapseConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: SynapseConnection | null): void {
