...
test('generated protocol uses synapse profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `synapse profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `synapse profiles list` for the LIVE/)
})
