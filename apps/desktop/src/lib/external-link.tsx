...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|synapse):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.synapseDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.synapseDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Synapse, and it is the surface the agent
