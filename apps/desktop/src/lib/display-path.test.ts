...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/synapse-agent')).toBe('~/www/synapse-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/synapse-agent')).toBe('synapse-agent')
    expect(pathLeaf('~/www/synapse-agent')).toBe('synapse-agent')
