...
import type { ModelOptionsResponse, SessionInfo } from '@/types/synapse'
 ...
 *
 * Only the leading status prefix (e.g. "Synapse is thinking...") and the
 ...
 *  resolved comment as JSON (SynapsePrComment shape); a malformed payload falls
