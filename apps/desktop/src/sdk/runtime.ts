 ...
 * plugins resolve `@synapse/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __SYNAPSE_PLUGIN_SDK__: sdk,
  __SYNAPSE_REACT__: React,
  __SYNAPSE_REACT_JSX__: jsxRuntime,
  __SYNAPSE_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@synapse/plugin-sdk': shimUrl('__SYNAPSE_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__SYNAPSE_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__SYNAPSE_REACT_JSX__'),
    react: shimUrl('__SYNAPSE_REACT__')
  }
