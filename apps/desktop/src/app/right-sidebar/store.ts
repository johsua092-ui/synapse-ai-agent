...
const TAKEOVER_KEY = 'synapse.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Synapse can't clear via the API — the user
 *  sees exactly what runs instead of Synapse silently deleting their creds. */
