import type { SynapseReviewFile } from '@/global'
...
export function buildReviewFlatList(files: SynapseReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: SynapseReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
