...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/synapse'
...
const VERSION = 3
const PREFIX = 'HML' // "Synapse Memory Loadout" — namespaces our codes like WoW's leading bytes.
