...
import type { SynapseGitBranch } from '@/global'
...
const branchActionLabel = (branch: SynapseGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<SynapseGitBranch[]>([])
  ...
  const convert = async (branch: SynapseGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
