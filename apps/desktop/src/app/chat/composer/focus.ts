...
const FOCUS_EVENT = 'synapse:composer-focus'
const INSERT_EVENT = 'synapse:composer-insert'
const ATTACH_IMAGES_EVENT = 'synapse:composer-attach-images'
const INSERT_REFS_EVENT = 'synapse:composer-insert-refs'
const SUBMIT_EVENT = 'synapse:composer-submit'
const VOICE_TOGGLE_EVENT = 'synapse:composer-voice-toggle'
const MODEL_MENU_EVENT = 'synapse:composer-model-menu'
