...
vi.mock('@/synapse', () => ({
  saveSynapseConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setSynapseConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useSynapseConfigRecord: () => ({ data: mocks.loadedConfig })
}))
