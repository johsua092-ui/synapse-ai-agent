...
function fontFamilyFromConfig(config: SynapseConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useSynapseConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<SynapseConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setSynapseConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="synapse-terminal-font-families"
          ...
          <datalist id="synapse-terminal-font-families">
