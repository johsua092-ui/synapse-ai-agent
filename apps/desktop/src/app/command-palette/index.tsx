...
import { getSynapseConfigRecord, listAllProfileSessions } from '@/synapse'
...
// Synapse session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: () => getSynapseConfigRecord()
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-synapse',
            keywords: ['update', 'upgrade', 'synapse', 'version', 'system', 'restart'],
            label: cc.updateSynapse,
