...
/**
 * Nous — the canonical Synapse desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Synapse's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Synapse desktop identity: GitHub's chrome carrying Nous
