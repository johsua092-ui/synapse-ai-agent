/**
 * Synapse skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$SYNAPSE_HOME/skins/` (or a
 * built-in) resolved by `synapse_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Synapse authors from a prompt lights up all three surfaces from one file.
 *
 ...
 */
export function skinToDesktopTheme(skin: SynapseSkin): DesktopTheme | null {
