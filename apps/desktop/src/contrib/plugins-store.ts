 ...
 * `<synapse home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'synapse.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'synapse.desktop.disabledPlugins.v1'
