...
const STORAGE_KEY = 'synapse.desktop.layoutTree.v2'

writeKey('synapse.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('synapse.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('synapse.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'synapse.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'synapse.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'synapse.desktop.hiddenStripTabs.v1'
...
writeKey('synapse.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__SYNAPSE_LAYOUT_TREE__ = {
    close: closeTreePane,
