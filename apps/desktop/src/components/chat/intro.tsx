...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should Synapse look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} Synapse need to see?`,
    ...
    {
      headline: `What should ${label} Synapse tackle?`,
  ...
  return (
    ...
    >
      <div className="w-full min-w-0">
        <p
          aria-label={WORDMARK}
          className="fit-text mx-auto mb-1 w-[calc(100%-1rem)] font-['Collapse'] font-bold uppercase leading-none tracking-[0.08em] text-midground dark:text-foreground/90 dark:mix-blend-plus-lighter"
