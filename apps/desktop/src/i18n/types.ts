...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshSynapsePathTitle: string
      sshSynapsePathDesc: string
      sshSynapsePathPlaceholder: string
  ...
  commandCenter: {
    ...
    synapseActiveSessions: (version: string, count: number) => string
