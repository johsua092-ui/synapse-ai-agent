...
export const en: Translations = {
  ...
  boot: {
    ready: 'Synapse Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Synapse settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Synapse backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingSynapseDesktop: 'Starting Synapse Desktop…'
    },
    errors: {
      backgroundExited: 'Synapse background process exited.',
      backgroundExitedDuringStartup: 'Synapse background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Synapse backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateSynapse: 'Update Synapse',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Synapse Desktop.',
    ...
    native: {
      ...
      inputBody: 'Synapse is waiting for your response.',
      turnDoneTitle: 'Synapse finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `synapse debug share --nous` from a terminal, or `synapse debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Synapse defaults?',
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Synapse backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Synapse backend to manage this plugin from Desktop.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.synapse/plugins/)`,
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Synapse is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Synapse asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Synapse was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Synapse was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Synapse follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Synapse can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Synapse is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Synapse, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Synapse runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Synapse checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Synapse configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Synapse.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Synapse gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Synapse Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Synapse Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Synapse runtime managed by this app.',
      kindRemoteDesc: 'A Synapse gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Synapse Cloud account.',
      kindSshDesc: 'A Synapse install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Synapse manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Synapse Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Synapse backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset SYNAPSE_DESKTOP_REMOTE_URL and SYNAPSE_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Synapse backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Synapse backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Synapse Cloud',
      cloudDesc: 'Sign in once to Synapse Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Synapse Cloud',
      cloudSignIn: 'Sign in to Synapse Cloud',
      cloudSignedIn: 'Signed in to Synapse Cloud',
      cloudNeedsSignIn: 'Sign in to Synapse Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Synapse Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Synapse Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Synapse Cloud',
      cloudSignedOutMessage: 'Cleared the Synapse Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /synapse.',
      ...
      restartingMessage: 'Synapse Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Synapse ${version}` : ''}`,
      ...
      sshDesc:
        'Synapse is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshSynapsePathTitle: 'Synapse path (optional)',
      sshSynapsePathDesc: 'Full path to the remote synapse binary. Blank = auto-detect.',
      sshSynapsePathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Synapse found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Synapse runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Synapse is not installed on the remote host. Install it there (curl -fsSL https:///install.sh | sh) or set the Synapse path.',
      sshErrPlatform:
        'Unsupported remote platform. Synapse Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Synapse on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Synapse. Review the exact configuration below — it comes from the link, not from Synapse.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Synapse runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Synapse at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via synapse curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Synapse builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Synapse to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Synapse to generate pets.',
      backgroundHint: 'You can close this — Synapse will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Synapse desktop' },
    ...
    synapseActiveSessions: (version, count) => `Synapse ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@synapse:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Synapse you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://synapse.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Synapse environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Synapse did not save that model change.'
    },
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Synapse will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Synapse backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Synapse. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Synapse backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Synapse...',
    placeholderReconnecting: 'Reconnecting to Synapse…',
    ...
    attachUrlDesc: 'Synapse will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Synapse to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Synapse…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Synapse…',
    ...
    unsupportedMessage: 'This version of Synapse can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Synapse from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Synapse will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Synapse desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Synapse updater takes over in its own window and reopens Synapse automatically when it’s done. Please don’t reopen Synapse yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Synapse reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Synapse reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Synapse?',
    blockerBody:
      'Synapse needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Synapse',
    foreignBlockerBody:
      'Synapse can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Synapse can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    oneTimeTitle: 'Synapse needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Synapse Desktop',
    setupChoiceDesc:
      'Connect this app to a Synapse gateway you already run, or install Synapse locally on this computer.',
    connectExistingTitle: 'Connect to existing Synapse',
    ...
    installLocalTitle: 'Install Synapse locally',
    installLocalDesc: 'Download Synapse, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Synapse Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Synapse',
    remoteSetupDesc: 'Enter your gateway URL. Synapse Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Synapse gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/synapse',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Synapse gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Synapse Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Synapse CLI or desktop instance is running. Stop any running Synapse instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Synapse Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Synapse is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Synapse…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Synapse',
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Synapse connects automatically',
    ...
    authorizeThere: 'Authorize Synapse there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Synapse there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Synapse Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Synapse Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Synapse will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Synapse is restarting...',
      askRestart: 'Ask Synapse to restart the server',
      lookingRestart: taskId => `Synapse is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Synapse is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Synapse to open a page.',
      finishedRestarting: message => `Synapse finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Synapse could not restart the server.',
      stillWorking:
        'Synapse is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Synapse is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Synapse gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.synapse/config.yaml). Synapse won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Synapse needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Synapse needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Synapse Desktop to use Save Image.',
    restartToSaveImages: 'Restart Synapse Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `synapse gateway` running?'
    }
  },
