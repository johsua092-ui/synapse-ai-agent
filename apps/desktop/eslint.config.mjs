...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @synapse/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@synapse/shared'],
              message: 'Plugins import only @synapse/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
