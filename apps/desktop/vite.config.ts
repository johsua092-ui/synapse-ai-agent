...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\synapse\synapse-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@synapse/plugin-sdk': path.resolve(import.meta.dirname, './src/sdk/index.ts'),
      '@synapse/shared/billing': path.resolve(import.meta.dirname, '../shared/src/billing-types.ts'),
      '@synapse/shared': path.resolve(import.meta.dirname, '../shared/src'),
