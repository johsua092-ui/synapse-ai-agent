...
export default defineConfig(({ command }) => ({
  ...
  resolve: {
    alias: {
      ...
      '@synapse/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@synapse/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@synapse/shared': path.resolve(__dirname, '../shared/src'),
