...
// even though a fresh shell — and the Synapse CLI — sees it immediately. The
// desktop's SYNAPSE_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\synapse. Reading
...
//       SYNAPSE_HOME    REG_SZ    F:\Synapse\data
//
