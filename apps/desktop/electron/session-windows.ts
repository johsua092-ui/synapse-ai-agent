...
// by main.ts (`setBackgroundThrottling` driven by the merged `synapse:active-work`
...
// (the "Synapse idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey Synapse" wake word has NO preceding click,
