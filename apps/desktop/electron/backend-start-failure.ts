 ...
 * startSynapse() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startSynapse() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startSynapse`, re-emits
