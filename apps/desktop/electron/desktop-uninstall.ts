 ...
 *
 *   macOS:   …/Hermes.app/Contents/MacOS/Synapse  → …/Hermes.app
 *   Windows: …\Synapse\Hermes.exe                 → …\Synapse  (install dir)
...
function resolveRemovableAppPath(execPath, platform, env: any = {}) {
  ...
  if (platform === 'darwin') {
    // …/Hermes.app/Contents/MacOS/Synapse → strip 3 segments to the .app
