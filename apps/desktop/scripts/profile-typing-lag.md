...
cd apps/desktop
XCURSOR_SIZE=24 SYNAPSE_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/synapse-typing
# → /tmp/synapse-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/synapse-typing.before.heapsnapshot
# → /tmp/synapse-typing.after.heapsnapshot
```
