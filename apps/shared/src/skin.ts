/**
 * Canonical Synapse skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$SYNAPSE_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`synapse_cli/skin_engine.py`),
 ...
 *   • CLI     → `synapse_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
