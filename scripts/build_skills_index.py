#!/usr/bin/env python3
"""Build the Synapse Skills Index — a centralized JSON catalog of all skills.
...
`synapse skills search/install` can use it without hitting the GitHub API.
...
# Ensure SYNAPSE_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Synapse Skills Index...", flush=True)
