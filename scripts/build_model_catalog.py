#!/usr/bin/env python3
"""Build the Synapse Model Catalog — a centralized JSON manifest of curated models.
...
Synapse CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Synapse release.
...
# Ensure SYNAPSE_HOME is set for imports that touch it at module level.
os.environ.setdefault("SYNAPSE_HOME", os.path.join(os.path.expanduser("~"), ".synapse"))

from synapse_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "synapse-agent repo",
            "docs": "https:///docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Synapse '
