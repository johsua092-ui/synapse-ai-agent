#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Synapse logs.
...
With no LOGFILE, reads ``$SYNAPSE_HOME/logs/agent.log`` (default ~/.synapse).
...
def default_log() -> Path:
    home = os.environ.get("SYNAPSE_HOME") or str(Path.home() / ".synapse")
