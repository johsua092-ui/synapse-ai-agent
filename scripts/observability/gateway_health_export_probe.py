...
def main() -> None:
    ...
    synapse_home = Path(tempfile.mkdtemp(prefix="synapse-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "synapse-gateway-smoke",
    ...
    print(json.dumps({"synapse_home": str(synapse_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
