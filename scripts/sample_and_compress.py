...
DEFAULT_DATASETS = [
    "Josh Research/swe-terminus-agent-glm-kimi-minimax",
    "johsua092-ui/synapse-ai-agent-megascience-sft1",
    "johsua092-ui/synapse-ai-agent-Thinking-GLM-4.7-SFT2",
    "johsua092-ui/synapse-ai-agent-Thinking-GLM-4.7-SFT1",
    "Josh Research/terminal-tasks-glm-synapse-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "Josh Research/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload Josh Research/{output_name} {final_output}")
