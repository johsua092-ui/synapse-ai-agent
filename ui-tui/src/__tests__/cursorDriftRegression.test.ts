 ...
 *
 * Symptom: in `synapse --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@synapse/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using synapse --tui and as i type multiline my caret at the end will often ' +
