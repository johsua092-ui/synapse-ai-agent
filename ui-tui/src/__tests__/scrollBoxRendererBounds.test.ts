...
import { Box, renderSync, ScrollBox, type ScrollBoxHandle, Text } from '@synapse/ink'
import React, { useLayoutEffect, useRef } from 'react'
import { describe, expect, it, vi } from 'vitest'

import SourceBox from '../../packages/synapse-ink/src/ink/components/Box.js'
import SourceScrollBox from '../../packages/synapse-ink/src/ink/components/ScrollBox.js'
import SourceText from '../../packages/synapse-ink/src/ink/components/Text.js'
import type { DOMElement } from '../../packages/synapse-ink/src/ink/dom.js'
import Output from '../../packages/synapse-ink/src/ink/output.js'
import { scrollFastPathStats as sourceScrollFastPathStats } from '../../packages/synapse-ink/src/ink/render-node-to-output.js'
import { renderSync as renderSourceSync } from '../../packages/synapse-ink/src/ink/root.js'
