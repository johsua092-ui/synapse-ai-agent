import { Box, type ScrollBoxHandle, stringWidth, Text } from '@synapse/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (SYNAPSE_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (SYNAPSE_DEV_CREDITS), lowest priority,
