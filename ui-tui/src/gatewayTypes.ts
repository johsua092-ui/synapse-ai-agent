import type { BillingBlock, UsageModelData } from '@synapse/shared/billing'
import type { SynapseSkin } from '@synapse/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@synapse/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = SynapseSkin
...
// Wire shapes now live in @synapse/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
