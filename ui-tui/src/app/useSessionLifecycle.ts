...
import type { ScrollBoxHandle } from '@synapse/ink'
import { evictInkCaches } from '@synapse/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.SYNAPSE_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
