...
await build({
  ...
  // Skip the prebuilt @synapse/ink bundle and inline the source instead:
  ...
  alias: { '@synapse/ink': resolve(root, 'packages/synapse-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The synapse_cli launcher
