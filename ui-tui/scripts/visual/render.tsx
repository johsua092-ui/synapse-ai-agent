 ...
 * across theme x background scenes to <tmpdir>/synapse-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@synapse/ink'
...
// The regenerated slate light_colors block from synapse_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/synapse-agent',
...
const setup = (bgHex: string) => {
  process.env.SYNAPSE_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
