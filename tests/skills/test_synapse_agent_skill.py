"""The `synapse-agent` skill is what a running Synapse knows about itself.

`website/` is never packaged, so an installed Synapse has no local copy of the
user guide; skills ARE synced into `$SYNAPSE_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Synapse can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "synapse-agent"
