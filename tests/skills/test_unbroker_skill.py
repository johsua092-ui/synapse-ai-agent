...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and synapse-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # synapse-agent (tests/skills/)
]
