...
The unit tests in tests/synapse_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned synapse-writable by the
...
from synapse_cli.service_manager import S6ServiceManager
