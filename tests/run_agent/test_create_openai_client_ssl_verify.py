...
_CA_ENV_VARS = ("SYNAPSE_CA_BUNDLE", "SSL_CERT_FILE", "REQUESTS_CA_BUNDLE", "HTTPS_PROXY")
...
def test_build_keepalive_http_client_uses_synapse_ca_bundle(clean_tls_env, monkeypatch):
    monkeypatch.setenv("SYNAPSE_CA_BUNDLE", certifi.where())
