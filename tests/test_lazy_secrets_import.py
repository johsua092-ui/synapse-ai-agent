"""Regression test: synapse update must not load cryptography eagerly."""
...
assert 'synapse_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running synapse update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so synapse_cli is importable,
...
import synapse_cli.main
from synapse_cli.update_cmd import _cmd_update_check
