...
thinking phase.  Synapse's default cloud-stream stale detector
(``SYNAPSE_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``SYNAPSE_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
