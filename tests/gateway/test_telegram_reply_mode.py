...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/johsua092-ui/synapse-agent/issues/23994:
...
class TestDMTopicSyntheticSendRouting:
    ...
    Regression tests for https://github.com/johsua092-ui/synapse-agent/issues/87051:
