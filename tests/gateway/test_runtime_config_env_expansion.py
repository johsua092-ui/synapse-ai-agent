...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("SYNAPSE_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("SYNAPSE_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("SYNAPSE_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
