"""Tests for _setup_feishu() in synapse_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("synapse_cli.config.save_env_value", side_effect=mock_save), \
         patch("synapse_cli.config.get_env_value", side_effect=mock_get), \
         patch("synapse_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("synapse_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("synapse_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("synapse_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("synapse_cli.cli_output.print_header"), \
         patch("synapse_cli.cli_output.print_info"), \
         patch("synapse_cli.cli_output.print_success"), \
         patch("synapse_cli.cli_output.print_warning"), \
         patch("synapse_cli.cli_output.print_error"), \
