...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.synapse/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at synapse_state import time, before pytest's SYNAPSE_HOME monkeypatch
    fires — the autouse fixture's SYNAPSE_HOME override doesn't help here.)
    """
