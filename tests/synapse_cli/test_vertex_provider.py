...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (synapse_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_synapse_overlays():
    """synapse_cli.providers.get_provider("vertex") backs
