...
class TestNousModelReasoningCapabilities:
    def test_fetch_parses_mandatory_flag(self, cold_cache, monkeypatch):
        from synapse_cli.models import nous_model_reasoning_capabilities
    ...
    def test_catalog_read_follows_the_configured_endpoint(
        ...
        """
        from synapse_cli.models import nous_catalog_url

        monkeypatch.setenv(
            "NOUS_INFERENCE_BASE_URL", "https:///v1"
        )
        assert nous_catalog_url() == "https:///v1/models"
