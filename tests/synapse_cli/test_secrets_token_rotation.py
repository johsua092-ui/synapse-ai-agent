"""Tests for `synapse secrets bitwarden token` / `synapse secrets onepassword token`.
...
from synapse_cli import onepassword_secrets_cli as op_cli
from synapse_cli import secrets_cli as bw_cli
