"""Regression: ``synapse update`` should take a managed checkout off autocrlf=true.
...
``synapse update`` has to repair them.
...
from synapse_cli.update_cmd import _normalize_managed_eol
