...
class TestGetCopilotModelContext:
    ...
    @patch("synapse_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("synapse_cli.models._urlopen_model_catalog_request")
    ...
    @patch("synapse_cli.models.fetch_github_model_catalog", return_value=[])
