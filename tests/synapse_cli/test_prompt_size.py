"""Tests for the ``synapse prompt-size`` diagnostic (issue #34667)."""
...
from synapse_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(synapse_home, memory_text="", user_text=""):
    mem_dir = synapse_home / "memories"
...
def _seed_skill(synapse_home, name, description):
    skill_dir = synapse_home / "skills" / "demo" / name
