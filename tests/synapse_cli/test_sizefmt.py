"""Tests for the shared byte formatter (synapse_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from synapse_cli.backup import _format_size as backup
    from synapse_cli.checkpoints import _fmt_bytes as checkpoints
    from synapse_cli.doctor import _human_bytes as doctor
