...
The notice prints the most recent curator run summary on `synapse update`,
...
session start) so users normally never see the rename map. `synapse update`
