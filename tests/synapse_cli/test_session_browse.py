"""Tests for the interactive session browser (`synapse sessions browse`).
...
from synapse_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """synapse sessions browse should be parseable."""
