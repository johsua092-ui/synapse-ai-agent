...
substring check, missing case variants and matching lookalike URLs). Synapse
...
from synapse_cli.cli_agent_setup_mixin import CLIAgentSetupMixin
...
def test_nous_portal_host_detection():
    ...
    assert base_url_host_matches("https:///v1", "")
    assert base_url_host_matches("https://", "")
    assert not base_url_host_matches("https://.evil.io/v1", "")
