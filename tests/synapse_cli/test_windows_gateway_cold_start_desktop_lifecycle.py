...
from synapse_cli import gateway as synapse_gateway
from synapse_cli import gateway_windows
from synapse_cli import main as cli_main
from synapse_cli import process_identity
...
def test_control_plane_argv_is_not_a_gateway():
    ...
    serve = "C:\\Synapse\\.venv\\Scripts\\python.exe -m synapse_cli.main serve --host 127.0.0.1"
    run = "C:\\Synapse\\.venv\\Scripts\\python.exe -m synapse_cli.main gateway run"
...
def test_control_plane_classifier_is_token_based_not_substring():
    ...
    py = "C:\\Synapse\\.venv\\Scripts\\python.exe -m synapse_cli.main"
...
def test_pause_skips_cold_start_plan_when_desktop_owns_lifecycle(monkeypatch):
    ...
    monkeypatch.setattr(synapse_gateway, "find_gateway_pids", lambda **_k: [])
