"""Tests for the specifier module + `synapse kanban specify` CLI surface.
...
from synapse_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `synapse kanban …` argparse surface directly."""
