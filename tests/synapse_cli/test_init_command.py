...
Covers the shared prompt builder (synapse_cli.init_command.build_init_prompt)
...
from synapse_cli.init_command import (
    _QUALITY_BAR,
    build_init_prompt,
...
class TestInitRegistryWiring:
    ...
    def test_init_works_on_the_gateway(self):
        ...
        from synapse_cli.commands import GATEWAY_KNOWN_COMMANDS
