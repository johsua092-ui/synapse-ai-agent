"""Tests for `synapse chat --safe-mode` isolation."""
...
_VARS = ("SYNAPSE_SAFE_MODE", "SYNAPSE_IGNORE_USER_CONFIG", "SYNAPSE_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["SYNAPSE_SAFE_MODE"] == "1"
        assert os.environ["SYNAPSE_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["SYNAPSE_IGNORE_RULES"] == "1"
        return True
