"""Tests for `_can_open_graphical_browser()` in synapse_cli.auth.

Guards the fix for the May 2026 report where `synapse auth add xai-oauth`
...
from synapse_cli.auth import _can_open_graphical_browser
