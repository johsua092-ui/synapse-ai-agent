...
The oneshot path builds its AIAgent directly (bypassing SynapseCLI), so the
...
from synapse_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
