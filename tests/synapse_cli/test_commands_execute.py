...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`synapse_cli.slash_exec.EXECUTORS`, and
...
from synapse_cli.commands import COMMAND_REGISTRY, resolve_command
from synapse_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,
