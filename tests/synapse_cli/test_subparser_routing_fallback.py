...
The main() function in synapse_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `synapse -c model`
...
def _build_parser():
    """Build a minimal replica of the synapse top-level parser."""
