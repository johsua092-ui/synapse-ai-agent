...
from synapse_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/synapse_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("synapse_cli.lifecycle.invoke_hook")
@patch("synapse_cli.lifecycle.finalize_session")
