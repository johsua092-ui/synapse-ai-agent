...
Keeps the ACP server tests offline: ``SynapseACPAgent._build_model_state``
calls ``synapse_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import synapse_cli.inventory as inventory
