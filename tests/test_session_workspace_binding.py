"""Session <-> workspace grouping key (synapse_state.workspace_key).

The key is what `synapse sessions list --workspace` groups/filters on. It is a
...
from synapse_state import workspace_key
