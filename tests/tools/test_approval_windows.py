...
must match regardless of host OS (a Linux-hosted Synapse can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\synapse\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/synapse/.env",
    ])
