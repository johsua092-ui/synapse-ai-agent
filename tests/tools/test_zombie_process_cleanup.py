...
class TestDelegationCleanup:
    ...
    def test_run_single_child_calls_close(self, monkeypatch, tmp_path):
        ...
        from synapse_cli.observability import relay_runtime
        ...
        def run_conversation(**_kwargs):
            observed["synapse_home"] = get_synapse_home()
        ...
        assert observed["synapse_home"] == profile_home
    ...
    def test_timed_out_child_keeps_relay_session_until_its_turn_exits(
        ...
        profile_token = set_synapse_home_override(profile_home)
        ...
        try:
            ...
            release_child.set()
            reset_synapse_home_override(profile_token)
            relay_runtime._reset_for_tests()
