...
def ledger_env(tmp_path, monkeypatch):
    """Isolated SYNAPSE_HOME + skills dir for skill_manage and the ledger."""
    ...
    monkeypatch.setattr(skill_ledger, "get_synapse_home", lambda: home)
    monkeypatch.setattr(skill_usage, "get_synapse_home", lambda: home)
...
def test_rollback_refuses_paths_outside_synapse_home(ledger_env):
    """A hand-edited ledger entry pointing outside SYNAPSE_HOME must not
