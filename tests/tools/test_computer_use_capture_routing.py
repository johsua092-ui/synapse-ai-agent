...
* ``synapse_constants.get_synapse_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_synapse_dir so cache writes land under tmp_path."""
    ...
    with patch("synapse_constants.get_synapse_dir", _fake_get):
        yield cache_dir
