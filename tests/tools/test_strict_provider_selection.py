"""Strict tool-provider selection: the `synapse tools` choice always wins.
...
selection and pointing at `synapse tools`.
...
class TestImageFalStrictSelection:
    ...
    def test_nous_selection_unentitled_raises_selection_error(self):
        ...
        assert "synapse tools" in str(exc.value)
