...
(3 SDK retries x 3 Synapse retries), and every one of those calls counts
...
def _state_path() -> str:
    ...
    try:
        ...
        base = get_synapse_home()
    except ImportError:
        base = os.path.join(os.path.expanduser("~"), ".synapse")
...
def is_genuine_nous_rate_limit(
    *,
    ...
    MiMo, Synapse, ...) behind one endpoint.  A 429 can mean either:
