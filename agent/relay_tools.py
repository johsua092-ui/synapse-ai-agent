"""Core NeMo Relay adapter for Synapse tool execution."""
    ...
    try:
        ...
        if (
            ...
            logger.warning(
                ...
                "returning the Synapse tool result",
                exc_info=True,
            )
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous Synapse Relay tool execution cannot run on an active event-loop thread"
    )
