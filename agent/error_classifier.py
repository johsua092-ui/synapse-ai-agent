...
# ``data:`` field before Synapse receives a completion chunk.  Keeping this
...
#
# See: https://github.com/johsua092-ui/synapse-ai-agent/issues/27344
...
# case: a stream dies mid-response and Synapse persists a content-less
...
# Request parameters that Synapse sends on SOME routes only, paired with the
...
def classify_api_error(
    ...
    *,
    ...
    # synapse_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from synapse_cli.plugins import get_plugin_error_classification
